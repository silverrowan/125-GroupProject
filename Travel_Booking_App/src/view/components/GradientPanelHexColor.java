 ...
 * @author rowan
 */
public class GradientPanelHexColor extends JPanel {
     ...
     * Constructors:
     */
    public GradientPanelHexColor() {
        this( new FlowLayout(), 0 );
    }

    public GradientPanelHexColor(int roundCorners) {
        this( new FlowLayout(), roundCorners );
    }
    
    public GradientPanelHexColor(LayoutManager layout) {
        //def colors: top: Bright ocean green/teal color, bottom: Bold orange     
        this( layout, "#ccffcc", "#ff962e", 0 );                                   
    }

    public GradientPanelHexColor(LayoutManager layout, int roundCorners) {
        //def colors: top: Bright ocean green/teal color, bottom: Bold orange     
        this( layout, "#ccffcc", "#ff962e", roundCorners );                                   
    }
    
    public GradientPanelHexColor(String Top, String Bottom) {
        this( new FlowLayout(), Top, Bottom, 0 );
    }

    public GradientPanelHexColor(String Top, String Bottom, int roundCorners) {
        this( new FlowLayout(), Top, Bottom, roundCorners );
    }
    
    public GradientPanelHexColor(LayoutManager layout, String Top, String Bottom, int roundCorners) {
