...
public class ViewDestinationsGUI extends javax.swing.JFrame {
    ...
    private JLabel hotelFullAddressLbl; //to be complete address of the Hotel
    /**
    ...
    public ViewDestinationsGUI() {
        ...
        hotelFullAddressLbl = new JLabel("No record selected");
        this.add(hotelFullAddressLbl);
        this.setVisible(true);
    }
    //bridge to contoller for field
    public void updateHotelFullAddressLbl(String text) {
        hotelFullAddressLbl.setText(text);
    }

//    public void setHotelFullAddressLbl(JLabel hotelFullAddressLbl) {
////        this.hotelFullAddressLbl = hotelFullAddressLbl;
//    }
